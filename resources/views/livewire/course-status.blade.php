<div class="mt-8 container grid grid-cols-1 lg:grid-cols-3">
    ...
    <div class="lg:col-span-2 gap-8">
        ...
        <div class="card mt-2">
            <div class="card-body flex text-gray-500 font-bold">
                ...
                @if ($this->previus)
                    <a class="cursor-pointer" wire:click="changeLesson({{ $this->previus }})">
                        Tema anterior
                    </a>
                @endif

                @if ($this->next)
                    <a class="ml-auto cursor-pointer" wire:click="changeLesson({{ $this->next }})">
                        Siguiente tema
                    </a>
                @endif
            ...
            <ul>
                @foreach ($course->sections as $section)
                    <li class="text-gray-600 mb-4">
                        <a class="font-bold text-base inline-block mb-1">
                            {{ $section->name }}
                        </a>
